...
#define _SYS_FLASH_VECTOR_TABLE_SHIFT	2000	// application will locate at 0x08002000
...
#define MSP430_SBWTDIO_SETINPUT()		SW_SETINPUT()
...
#define ISSP_SDATA_SETINPUT()			SW_SETINPUT()
...
#define ISSP_XRES_SETINPUT()			SW_RST_SETINPUT()
...
#define C2_C2D_SETINPUT()				SW_SETINPUT()
...
#define LPCICP_SDATA_SETINPUT()			SW_SETINPUT()
...
#define LPCICP_XRES_SETINPUT()			SW_RST_SETINPUT()
/*
#define LPCICP_PowerOn()				PWREXT_ENABLE()
#define LPCICP_PowerOff()				PWREXT_DISABLE()
*/
/****************************** I2C ******************************/
#define I2C_SCL_SET()					SW_RST_SET()
#define I2C_SCL_CLR()					SW_RST_CLR()
#if (_HARDWARE_VER == STM32_MINI) || (_HARDWARE_VER == STM32_NANO)
#	define I2C_SCL_SETOUTPUT()			SW_RST_SETOUTPUT()
#	define I2C_SCL_SETINPUT()			SW_RST_SETINPUT()
#	define I2C_SCL_GET()				SW_RST_GET()
#elif (_HARDWARE_VER == STM32_PRO)
#	define I2C_SCL_SETOUTPUT()			GLOBAL_OUTPUT_Acquire()
#	define I2C_SCL_SETINPUT()			GLOBAL_OUTPUT_Release()
#	define I2C_SCL_GET()				1
#endif

#	define I2C_SDA_SETOUTPUT()			SW_SETOUTPUT()
#	define I2C_SDA_SETINPUT()			SW_SETINPUT()
#	define I2C_SDA_SET()				SW_SET()
