 ...
 *                                                                        *
 *  Project:    Versaloon                                                 *
 *  File:       hw_cfg_MiniRC2.h                                          *
 *  Author:     SimonQian                                                 *
 *  Versaion:   See changelog                                             *
 *  Purpose:    hardware configuration file for Mini Version RC2          *
 *  License:    See license                                               *
 *------------------------------------------------------------------------*
 *  Change Log:                                                           *
...
#define SW_RST_GET()					GPIO_GetOutPins(SW_RST_PORT, SW_RST_PIN)

#define SYNCSW_DIR_INIT()				SYNCSW_SETINPUT()
#define SYNCSW_SETINPUT()				GPIO_SetMode(SYNCSW_PORT, SYNCSW_PIN, GPIO_MODE_IPU)
#define SYNCSW_SETOUTPUT()				GPIO_SetMode(SYNCSW_PORT, SYNCSW_PIN, GPIO_MODE_OUT_PP)

#define SYNCSW_SET()					GPIO_SetPins(SYNCSW_PORT, SYNCSW_PIN)
#define SYNCSW_CLR()					GPIO_ClrPins(SYNCSW_PORT, SYNCSW_PIN)
#define SYNCSW_GET()					GPIO_GetInPins(SYNCSW_PORT, SYNCSW_PIN)
...
/****************************** ADC ******************************/
#define TVCC_PORT						GPIOA
#define TVCC_PIN						GPIO_PIN_5
#define TVCC_ADC_CHANNEL				ADC_Channel_5
...
#define KEY_Init()						do{ BKP_TamperPinCmd(DISABLE); GPIO_SetMode(KEY_PORT, KEY_PIN, GPIO_MODE_IPU); }while(0)
#define KEY_Fini()						do{ GPIO_SetMode(KEY_PORT, KEY_PIN, GPIO_MODE_IN_FLOATING); BKP_TamperPinCmd(ENABLE); }while(0)
