 ...
 *      2011-10-26:     adapt to STM32L-Discovery (by Bingo)              *
 *      2011-10-26:     Modify to use PB0/NRST as Target Reset(by Bingo)  *
 **************************************************************************/

//
// To make the STM32L-Discovery firmware
//
...
/****************************** STM32L-Discovery Pins ******************************/
#define STM32L_SWD_PORT				GPIOB
#define STM32L_T_JTCK_1_PORT			GPIOA
...
//		CN2 Pin4 = TCK/SWCLK
//
#define	STM32L_T_JTMS					GPIO_PIN_14	//GPIOB - Used as SWCLK
#define	STM32L_T_JTCK					GPIO_PIN_13	//GPIOB - Used as SWDIO OUT - Connected to PB13 on L board

#define	STM32L_T_JTCK_1				GPIO_PIN_5	//GPIOA - Used as SWDIO IN - Connected to PA5 on L board

#define	STM32L_SWIM_1					GPIO_PIN_8	//GPIOB
#define	STM32L_SWIM_2					GPIO_PIN_11	//GPIOB

#define	STM32L_SWIM_RST				GPIO_PIN_6	//GPIOB
#define	STM32L_SWIM_RST_IN				GPIO_PIN_5	//GPIOB

#define	STM32L_STM_JRST				PB4
#define	STM32L_STM_JTDO				PB3
#define	STM32L_STM_JTDI				PA15
#define	STM32L_STM_JTCK				PA14
#define	STM32L_STM_JTMS				PA13
#define STM32L_USB_DP					PA12
#define STM32L_USB_DM					PA11

#define	STM32L_U1_RX					PA10
#define	STM32L_U1_TX					PA9

#define	STM32L_ST_LINK_LED				GPIO_PIN_9	//GPIOA

#define STM32L_T_JRST					GPIO_PIN_1	//GPIOB
#define STM32L_T_NRST					GPIO_PIN_0	//GPIOB
#define	STM32L_T_JTDI					GPIO_PIN_7	//GPIOA
#define STM32L_T_JTDO					GPIO_PIN_6	//GPIOA

#define	STM32L_U2_CK					GPIO_PIN_4	//GPIOA
#define STM32L_U2_RX					GPIO_PIN_3	//GPIOA
#define STM32L_U2_TX					GPIO_PIN_2	//GPIOA	

/****************************** Power ******************************/
#define PWREXT_EN_PORT					GPIOA
#define PWREXT_EN_PIN					STM32L_U2_TX
...
#define SW_PIN							STM32L_T_NRST
#define SW_RST_PORT						GPIOB
#define SW_RST_PIN						STM32L_T_JRST

#define SYNCSW_IN_PORT					STM32L_T_JTCK_1_PORT
#define SYNCSW_IN_PIN					STM32L_T_JTCK_1
#define SYNCSW_OUT_PORT					STM32L_SWD_PORT
#define SYNCSW_OUT_PIN					STM32L_T_JTCK
...
#define JTAG_TAP_TCK_PIN				STM32L_T_JTMS
#define JTAG_TAP_TDO_PIN				STM32L_SWIM_RST
#define JTAG_TAP_TDI_PIN				STM32L_SWIM_RST_IN
...
#define LED_USB_PIN						9 //STM32L_ST_LINK_LED
