...
static const struct STKPARAM STK500V2_Param[] = 
{
	...
	STKPARAM_DECLEAR(PARAM_EXTERNAL_RESET, STKPARAM_ATTR_RW, 1, &STK500V2_PARAM_ExternalReset, 0),
	STKPARAM_DECLEAR(PARAM_DAISY_CHAIN_INFO, STKPARAM_ATTR_RW, 4, &STK500V2_PARAM_DaisyChain, STK500V2_OnWriteDaisyChain),
	STKPARAM_DECLEAR(PARAM_SOFT_RESET, STKPARAM_ATTR_W, 1, &STK500V2_PARAM_SoftReset, 0),
	STKPARAM_DECLEAR(PARAM_PDI_APP_OFFSET, STKPARAM_ATTR_W, 4, &STK500V2_PARAM_AppOffset, 0),
	STKPARAM_DECLEAR(PARAM_PDI_BOOT_OFFSET, STKPARAM_ATTR_W, 4, &STK500V2_PARAM_BootOffset, 0),
...
bool STK500V2_OnWriteEmuMode(const struct STKPARAM *param, uint8 attr)
{
	if (STKPARAM_ATTR_W == attr)
	{
		if((STK500V2_EmuMode == EMUMODE_MEGA_JTAG) 
