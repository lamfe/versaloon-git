...
void SCSI_ReadFormatCapacity_Cmd(uint8_t lun)
{
  ...
  ReadFormatCapacity_Data[7] = (uint8_t)(Mass_Block_Count[lun] >>  0);

  ReadFormatCapacity_Data[9] = (uint8_t)(Mass_Block_Size[lun]  >>  16);
  ReadFormatCapacity_Data[10] = (uint8_t)(Mass_Block_Size[lun] >>   8);
  ReadFormatCapacity_Data[11] = (uint8_t)(Mass_Block_Size[lun] >>   0);
...
void SCSI_ReadCapacity10_Cmd(uint8_t lun)
{
  ...
  ReadCapacity10_Data[3] = (uint8_t)((Mass_Block_Count[lun] - 1) >>  0);
  ...
  ReadCapacity10_Data[7] = (uint8_t)(Mass_Block_Size[lun] >>   0);
