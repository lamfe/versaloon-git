...
#define VSLLINK_CMDSWD_CMDMSK		0xC0
#define VSLLINK_CMDSWD_LENMSK		0x3F

#define VSLLINK_CMDSWD_SEQOUT		0x00
#define VSLLINK_CMDSWD_SEQIN		0x40
#define VSLLINK_CMDSWD_TRANS		0x80
#define VSLLINK_CMDSWD_PARA			0xC0
