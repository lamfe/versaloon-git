...
__declspec(weak) vectorTableEntryType vector_86  @Vfectxf = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_87  @Vfecrxf = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_88  @Vfecother = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_89  @Vfechberr = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_90  @Vfecbabr = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_91  @Vfecbabt = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_92  @Vfecgra = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_93  @Vfectxb = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_94  @Vfecrxb = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_95  @Vfecmii = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_96  @Vfeceberr = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_97  @Vfeclc = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_98  @Vfecrl = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_99  @Vfecun = asm_exception_handler;
