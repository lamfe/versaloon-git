...
#define BDM_DIR           PTFD_PTFD0
#define BDM_DIR_BIT       (0) // Bit #
#define BDM_DIR_MASK      (1<<BDM_DIR_BIT)

#define BDM_DIR_DDR       PTFDD_PTFDD0
#define BDM_DIR_PER       PTFPE_PTFPE0
...
// SYNC Detection TPM1.Ch1 : Input capture
#define SYNC_TPMxCnSC_CHF                 TPM1C1SC_CH1F       // Event Flag
#define SYNC_TPMxCnSC                     TPM1C1SC            // TPM Channel Status & Configuration
#define SYNC_TPMxCnSC_RISING_EDGE_MASK    TPM1C1SC_ELS1A_MASK // TPMxCnSC value for rising edge
#define SYNC_TPMxCnSC_FALLING_EDGE_MASK   TPM1C1SC_ELS1B_MASK // TPMxCnSC value for falling edge
#define SYNC_TPMxCnVALUE                  TPM1C1V             // IC Event time
