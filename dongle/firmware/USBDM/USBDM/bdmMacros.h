...
extern U8 doACKN_WAIT64(void);
extern U8 doACKN_WAIT150(void);
#define DO_ACKN_WAIT64()  doACKN_WAIT64()
#define DO_ACKN_WAIT150() doACKN_WAIT150()
...
#define BDM_CMD_1W1B_0_T(cmd, parameter1, parameter2) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)(((parameter1)>>8)&0xFF)),\
   bdm_tx((U8)((parameter1)&0xFF)),\
   bdm_tx((U8)((parameter2)&0xFF)), \
   enInterrupts())
   // NO bdm_txFinish()

//  Special truncated sequence
#define BDM_CMD_1B_0_T(cmd,parameter)\
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)&0xFF)), \
   enInterrupts())
   // NO bdm_txFinish()
...
#define BDM_CMD_0_0_NOACK(cmd) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_txFinish())
   
// Write cmd & read byte without ACK (HCS08)
#define BDM_CMD_0_1B_NOACK(cmd, result) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_txFinish(),\
      *((U8 *)((void *)(result)))=bdm_rx())

// Write cmd & byte without ACK (HCS08)
#define BDM_CMD_1B_0_NOACK(cmd,parameter)	\
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)&0xFF)),\
   bdm_txFinish())
...
#define BDM_CMD_0_1W_NOACK(cmd,parameter) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_txFinish(),\
      *((U8 *)((void *)(parameter)))=bdm_rx(), \
      *((U8 *)((void *)(parameter))+1)=bdm_rx())

// Write cmd & word without ACK
#define BDM_CMD_1W_0_NOACK(cmd,parameter) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)>>8)&0xFF),\
   bdm_tx((U8)((parameter)&0xFF)),\
   bdm_txFinish())
...
#define BDM_CMD_0_0(cmd) \
   (bdm_txPrepare(),\
    bdm_tx(cmd),\
    DO_ACKN_WAIT64())
   
// Write command + word
#define BDM_CMD_1W_0(cmd,parameter) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)>>8)&0xFF),\
   bdm_tx((U8)((parameter)&0xFF)),\
...
/* read word */
#define BDM_CMD_0_1W(cmd,parameter) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   DO_ACKN_WAIT64(), \
      *((U8 *)(parameter))=bdm_rx(), \
      *((U8 *)(parameter)+1)=bdm_rx())

/* write longword */
#define BDM_CMD_1L_0(cmd,parameter) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)>>24)&0xFF),\
   bdm_tx((U8)((parameter)>>16)&0xFF),\
   bdm_tx((U8)((parameter)>>8)&0xFF),\
   bdm_tx((U8)((parameter)&0xFF)),\
   DO_ACKN_WAIT64())
   
/* read longword */
#define BDM_CMD_0_1L(cmd,parameter) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   DO_ACKN_WAIT64(), \
      *((U8 *)(parameter)+0)=bdm_rx(), \
      *((U8 *)(parameter)+1)=bdm_rx(), \
      *((U8 *)(parameter)+2)=bdm_rx(), \
      *((U8 *)(parameter)+3)=bdm_rx())

#if 1
/* write word & read byte (read word but return byte - HC/S12(x)) */
#define BDM_CMD_1W_1WB(cmd, parameter, result)  \
   bdm_txPrepare(),                             \
   bdm_tx(cmd),                                 \
   bdm_tx((U8)(((parameter)>>8)&0xFF)),         \
   bdm_tx((U8)((parameter)&0xFF)),              \
...
#define BDM_CMD_1W_1WB(cmd, parameter, result)           \
   (bdm_txPrepare(),                                     \
    ...
    DO_ACKN_WAIT150(),                                   \
      ((parameter)&0x0001) ?                             \
         ((void)bdm_rx(),*((U8 *)(result))=bdm_rx(),0):  \
         (*((U8 *)(result))=bdm_rx(),(void)bdm_rx(),0))
#endif

/* write 2 words */
#define BDM_CMD_2W_0(cmd, parameter1, parameter2) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter1)>>8)&0xFF),\
   bdm_tx((U8)((parameter1)&0xFF)),\
   bdm_tx((U8)((parameter2)>>8)&0xFF),\
   bdm_tx((U8)((parameter2)&0xFF)),\
   DO_ACKN_WAIT150())

/* write word and a byte (sends 2 words, the byte in both high and low byte of the 16-bit value) */
#define BDM_CMD_2WB_0(cmd, parameter1, parameter2) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter1)>>8)&0xFF),\
   bdm_tx((U8)((parameter1)&0xFF)),\
...
#define BDM_CMD_1W_1W(cmd, parameter, result) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)>>8)&0xFF),\
   bdm_tx((U8)((parameter)&0xFF)),\
   DO_ACKN_WAIT150(),\
      *((U8 *) ((void *)(result)))=bdm_rx(),\
      *((U8 *) ((void *)(result))+1)=bdm_rx())

/* write word & read word */
#define BDM_CMD_1Wle_1Wle(cmd, parameter, result) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)&0xFF)),\
   bdm_tx((U8)((parameter)>>8)&0xFF),\
...
/* read word HCS08 */
#define BDM_CMD_0_1B(cmd,result)	\
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   DO_ACKN_WAIT64(),\
      *((U8 *)((void *)(result)))=bdm_rx())
...
/* write byte HCS08 */
#define BDM_CMD_1B_0(cmd,parameter)	\
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)&0xFF)),\
   DO_ACKN_WAIT64())
...
#define BDM_CMD_1W_1B(cmd, parameter, result)  \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)>>8)&0xFF),\
   bdm_tx((U8)((parameter)&0xFF)),\
   DO_ACKN_WAIT64(), \
      *((U8 *)((void *)(result)))=(U8)bdm_rx())
                                                         
/* write word & read byte (read word but return byte - HCS08 */
#define BDM_CMD_1Wle_1B(cmd, parameter, result)  \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter)&0xFF)),\
   bdm_tx((U8)((parameter)>>8)&0xFF),\
...
#define BDM_CMD_1W1B_0(cmd, parameter1, parameter2) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((parameter1)>>8)&0xFF),\
   bdm_tx((U8)((parameter1)&0xFF)),\
...
#define BDM_CMD_1A1B_0(cmd, addr, value) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((addr)>>16)&0xFF),\
   bdm_tx((U8)((addr)>>8)&0xFF),\
   bdm_tx((U8)((addr)&0xFF)),\
   bdm_tx((U8)((value))&0xFF),\
   DO_ACKN_WAIT150())

/* write 1 24-bit value then 1 word  */
#define BDM_CMD_1A1W_0(cmd, addr, value) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((addr)>>16)&0xFF),\
   bdm_tx((U8)((addr)>>8)&0xFF),\
   bdm_tx((U8)((addr)&0xFF)),\
   bdm_tx((U8)((value)>>8)&0xFF),\
   bdm_tx((U8)((value))&0xFF),\
   DO_ACKN_WAIT150())

/* write 1 24-bit value then 1 longword  */
#define BDM_CMD_1A1L_0(cmd, addr, value) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((addr)>>16)&0xFF),\
   bdm_tx((U8)((addr)>>8)&0xFF),\
   bdm_tx((U8)((addr)&0xFF)),\
   bdm_tx((U8)((value)>>24)&0xFF),\
   bdm_tx((U8)((value)>>16)&0xFF),\
   bdm_tx((U8)((value)>>8)&0xFF),\
   bdm_tx((U8)((value))&0xFF),\
   DO_ACKN_WAIT150())

/* write 24-bit address & read byte */
#define BDM_CMD_1A_1B(cmd, addr, result) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((addr)>>16)&0xFF),\
   bdm_tx((U8)((addr)>>8)&0xFF),\
...
#define BDM_CMD_1A_1W(cmd, addr, result) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((addr)>>16)&0xFF),\
   bdm_tx((U8)((addr)>>8)&0xFF),\
...
#define BDM_CMD_1A_1L(cmd, addr, result) \
   (bdm_txPrepare(),\
   bdm_tx(cmd),\
   bdm_tx((U8)((addr)>>16)&0xFF),\
   bdm_tx((U8)((addr)>>8)&0xFF),\
   ...
   DO_ACKN_WAIT150(),\
      *((U8 *) ((void *)(result)))=bdm_rx(),\
      *((U8 *) ((void *)(result))+1)=bdm_rx(),\
      *((U8 *) ((void *)(result))+2)=bdm_rx(),\
      *((U8 *) ((void *)(result))+3)=bdm_rx())

#endif

/* Definitions of the actual commands - these should be used in the C-code
 * All BDM commands need to be called with interrupts disabled (either by
 *  hand or, for example, from within an ISR)
...
/* read and write commands - LittleEndian */
...
/* read register commands - Little-Endian */
...
/* write register commands - Little-endian versions */
...
#define BDMCF_CMD_READ_REG(regNo,value_p)  BDM_CMD_0_1L(_BDMCF_READ_Rn|regNo,value_p)   //!< Read Register (CFv1)  - Little-Endian
#define BDMCF_CMD_READ_CREG(regNo,value_p) BDM_CMD_0_1L(_BDMCF_READ_CREG|regNo,value_p) //!< Read Control Register (CFv1)  - Little-Endian
#define BDMCF_CMD_READ_DREG(regNo,value_p) BDM_CMD_0_1L(_BDMCF_READ_DREG|regNo,value_p) //!< Read Debug Register (CFv1)  - Little-Endian
#define BDMCF_CMD_READ_PSTBe(regNo,value_p)  BDM_CMD_0_1L(_BDMCF_READ_PSTB|regNo,value_p) //!< Read Trace buffer (CFv1)  - Little-Endian
...
#define BDMCF_CMD_WRITE_REG(regNo,value)    BDM_CMD_1L_0(_BDMCF_WRITE_Rn|regNo,value)     //!< Write Register (CFv1) - Little-Endian
#define BDMCF_CMD_WRITE_CREG(regNo,value)   BDM_CMD_1L_0(_BDMCF_WRITE_CREG|regNo,value)   //!< Write Control Register (CFv1) - Little-Endian
#define BDMCF_CMD_WRITE_DREG(regNo,value)   BDM_CMD_1L_0(_BDMCF_WRITE_DREG|regNo,value)   //!< Write Debug Register (CFv1) - Little-Endian
