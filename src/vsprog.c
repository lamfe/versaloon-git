...
#define OPTSTR			"hvS:P:s:c:Mp:U:D:Ld:Go:F:m:x:C:I:O:J:Zb:V:t:K:W:B:"
static const struct option long_opts[] =
{
	...
	{"block-idx", required_argument, NULL, 'B'},
...
Parse_File:
		...
		case 'B':
			// --block-idx
			program_info.block_idx = (uint32_t)strtoul(optarg, NULL, 0);
			break;
		case 'J':
			// --jtag-dc
			cur_pointer = optarg;
