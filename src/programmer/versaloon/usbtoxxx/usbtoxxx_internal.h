...
// USB_TO_XXX Replys
#define USB_TO_XXX_SUCCESS			0x00
#define USB_TO_XXX_FAIL				0x08
#define USB_TO_XXX_NOT_IMPLEMENTED	0x10
#define USB_TO_XXX_PARA_ERROR		0x20
#define USB_TO_XXX_IDX_NOT_EXIST	0x28
#define USB_TO_XXX_DATA				0x80
