...
#define STM32F1_FLASH_PAGESIZE		128
#define STM32F1_FLASH_ADDR			0x08000000
#define STM32F1_SRAM_ADDR			0x20000000
#define STM32F1_FLASH_DEFAULT		0xFF
#define STM32F1_FLASH_BANK_SIZE		(512 * 1024)
#define STM32F1_FLASH_BANK1_ADDR	STM32F1_FLASH_ADDR
#define STM32F1_FLASH_BANK2_ADDR	\
	(STM32F1_FLASH_ADDR + STM32F1_FLASH_BANK_SIZE)
