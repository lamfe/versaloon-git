...
#define msp430_jtag_ir_w(i)									{ ir = i; msp430jtagsbw_ir(0, (uint8_t*)&ir); }
#define msp430_jtag_ir_rw(i, ptr)							{ *(uint8_t*)(ptr) = i; msp430jtagsbw_ir(0, (uint8_t*)(ptr)); }
#define msp430_jtag_dr16_w(d)								{ dr = SYS_TO_LE_U32(d); msp430jtagsbw_dr(0, (uint32_t*)&dr, 16); }
#define msp430_jtag_dr16_rw(d, ptr)							{ *(uint32_t*)(ptr) = SYS_TO_LE_U32(d); msp430jtagsbw_dr(0, (uint32_t*)(ptr), 16); }
#define msp430_jtag_dr20_w(d)								{ dr = SYS_TO_LE_U32(d); msp430jtagsbw_dr(0, (uint32_t*)&dr, 20, 0); } while(0)
#define msp430_jtag_dr20_rw(d, ptr)							{ *(uint32_t*)(ptr) = SYS_TO_LE_U32(d); msp430jtagsbw_dr(0, (uint32_t*)(ptr), 20); }
...
#define DR_Shift0()											{ dr = SYS_TO_LE_U32(1); msp430jtagsbw_dr(0, (uint32_t*)&dr, 1); }
