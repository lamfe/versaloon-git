...
#define SD_TRANSTOKEN_RESP_SPI_LENMSK		0x0007

#define SD_TRANSTOKEN_RESP_R1				(SD_TRANSTOKEN_RESP_SHORT | SD_TRANSTOKEN_RESP_CMD | SD_TRANSTOKEN_RESP_CRC7 | 1)
#define SD_TRANSTOKEN_RESP_R1B				(SD_TRANSTOKEN_RESP_R1 | SD_TRANSTOKEN_RESP_CHECKBUSY)
#define SD_TRANSTOKEN_RESP_R2				(SD_TRANSTOKEN_RESP_LONG | SD_TRANSTOKEN_RESP_CRC7 | 2)
#define SD_TRANSTOKEN_RESP_R3				(SD_TRANSTOKEN_RESP_SHORT | 5)
#define SD_TRANSTOKEN_RESP_R6				(SD_TRANSTOKEN_RESP_SHORT | SD_TRANSTOKEN_RESP_CMD | SD_TRANSTOKEN_RESP_CRC7)
#define SD_TRANSTOKEN_RESP_R7				(SD_TRANSTOKEN_RESP_SHORT | SD_TRANSTOKEN_RESP_CMD | SD_TRANSTOKEN_RESP_CRC7 | 5)
